...
ChatLogic::~ChatLogic()
{
    ...
    // -chatBot is now in the stack
    //delete _chatBot;

    // delete all nodes : smart poiter automatically handler the deletion
...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
            ...
            if (type != tokens.end())
            {
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        ...
                        {
                            // create unique_prt own the instance
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            // .get() to return a raw poiter from smart poiter
    ...
    // Create local ChatBot instance in stack
